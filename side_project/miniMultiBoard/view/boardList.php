...
<head>
    ...
    <script src="/view/bootstrap/js/board.js" defer></script>
   ...
   <main>
    ...
    ?>
      <div class="card" id="card<?php echo $item["b_id"]; ?>">
        <img src="<?php echo empty($item["b_img"]) ? "" : $item["b_img"]; ?>" class="card-img-top" alt="">
        <div class="card-body">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">  
              <div>
              <button id="my-btn-delete" type="button" class="btn btn-warning float-start" data-bs-dismiss="modal">삭제</button>
              </div>
